...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.demandeur'
        db.add_column('notes_event', 'demandeur',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)


        # Changing field 'Event.weekend'
        db.alter_column('notes_event', 'weekend', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting field 'Event.demandeur'
        db.delete_column('notes_event', 'demandeur')


        # Changing field 'Event.weekend'
        db.alter_column('notes_event', 'weekend', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'notes.event': {
            ...
            'couleur': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '10'}),
            'demandeur': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '100'}),
            ...
            'lenombre': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'weekend': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '20'})
        }
    }
