...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.weekend'
        db.add_column('notes_event', 'weekend',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.weekend'
        db.delete_column('notes_event', 'weekend')
    ...
    models = {
        ...
        'notes.event': {
            ...
            'weekend': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '10'})
        }
    }
