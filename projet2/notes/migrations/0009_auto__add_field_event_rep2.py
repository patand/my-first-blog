...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.rep2'
        db.add_column('notes_event', 'rep2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.rep2'
        db.delete_column('notes_event', 'rep2')
    ...
    models = {
        ...
        'notes.event': {
            ...
            'rep2': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
